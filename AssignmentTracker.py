...
class Assignment:
    ...
    def __init__(self, name: str, subject: str, deadline: datetime, points_possible: float, status: str = "not started"):
        self.HWname = name
        self.subject = subject
        self.deadline = deadline
        self.status = status

        self.points_earned = "--"  # Points earned for the assignment
...
class AssignmentTracker:
    ...
    def add_assignment(self, HWname: str, subject: str, deadline: datetime, points_possible: float, status: str = "not started"):
        """Adds an assignment to the list."""
        new_assignment = Assignment(HWname, subject, deadline, points_possible, status)
